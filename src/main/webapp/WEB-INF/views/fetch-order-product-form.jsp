...
<body>
	<div class=top>
		Fetch<a href="/customer/customerindex"><em class="fa fa-home" style="font-size: 30px;float:right; color: white"></em></a>
	</div>
	<br>
	<form action="/orders/findorderbycustomerid" method="get" style="margin: 0;">
		<div class=heading>
